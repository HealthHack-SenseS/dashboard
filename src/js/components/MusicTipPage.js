    ...
    return (
      <div className="music-tip-page">
        ...
        <div className="tip-page__content">
          <h4 className="tip-page__title"><i className="tip-page__title-icon fa fa-music"></i> Listen to music</h4>
          ...
          <div className="tip-page__button-container">
            ...
            <div className="button tip-page__start-button"><i className="fa fa-spotify"></i> Open Spotify</div>
          </div>
        </div>
      </div>
    );
